...
for i in range (number_of_tasks):
    ...
    if i == 0:
      print("В одном пенале 6 карандашей, а во втором - 2 карандаша. Сколько карандашей в вух пеналах?")
      answer =8
      ...
      print("Брату 8 лет. А сестра старше брата на 2 года. Сколько лет сесетре?")
      answer = 10
     ...
     if attempta == 0:
        print ("Ответ неверный. Верный ответ" + " " + str (anawer))
